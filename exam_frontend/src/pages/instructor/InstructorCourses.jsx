          ...
          {courses.map(course => (
            <Card key={course.id} style={{ display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 'var(--spacing-4)' }}>
                ...
                <span style={{ padding: '4px 8px', background: course.moderation_status === 'approved' ? 'rgba(16, 185, 129, 0.1)' : 'rgba(245, 158, 11, 0.1)', color: course.moderation_status === 'approved' ? 'var(--color-success)' : 'var(--color-warning)', borderRadius: '12px', fontSize: '0.75rem', fontWeight: 'bold', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>
